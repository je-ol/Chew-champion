    ...
    <div class="h-[80vh] flex items-center mt-[60px]">
        <div class="flex w-[26%] h-[80%] bg-[#758BFD] m-auto rounded-3xl text-white ">
            <form @submit.prevent="handleSubmit" class="flex flex-col h-[90%] w-[70%] m-auto justify-around items-center [text-shadow:_1px_1px_1px_rgb(0_0_0_/_50%)]"> 
                <h1 class=" text-3xl md:text-2xl font-extrabold ">Become a member!</h1>
                <input type="text" v-model="username"
                class="w-[100%] h-[9%] rounded pl-2 text-black md:text-sm"
                ...
                <div class="w-[100%] flex">
                    ...
                    class="mr-2">                
                    <p class="self-start font-bold cursor-pointer md:text-xs">You accept our <a href="/terms-of-service"
                    class="underline">terms of service</a></p>
                </div>

                <button class="text-xl md:text-sm font-extrabold bg-[#FA8531] py-2 px-6 rounded-md [text-shadow:_1px_1px_1px_rgb(0_0_0_/_60%)]"
                >REGISTER</button>
                <p class="font-semibold cursor-pointer md:text-sm">Already have an account? 
